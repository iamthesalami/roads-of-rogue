...
- 2026-09-24ay: LOADOUT PRESETS. The Smithy screen has a Loadouts section with three kits: "Save belt" stores your current quick slots, "Equip" rebuilds your belt from whatever you hold across belt + pack + armory (weapons you swap out go back on the rack) and flashes anything in the kit that's since been lost or used up. Stored in village.loadouts, so they persist. Verified in-browser: saved two kits, switched between them, weapons moved correctly between belt and armory, no console errors.
- 2026-09-24az: SMITHY vs ARMORY split. The Smithy is now forging only (upgrade / infuse / recolour); each belt or pack weapon in its list has a "To rack →" button to send a finished piece to the weapon rack. Pressing E at the Weapon Rack (no longer gated on the cult) opens THE ARMORY: your belt (with "To rack"), everything on the rack (with "Equip →"), and the three saved kits (Save belt / Equip). The Equip buttons and loadouts moved out of the Smithy. Help/tooltips updated. Verified in-browser incl. a real E press at a spawned rack; no console errors.
- 2026-09-24ba: SMITHY WEAPON DESIGN + PREVIEW. Root causes of "can't see or design what I'm building": (1) the Smithy had no preview at all; (2) a forged colour only did anything on generated (_wspec) weapons and was otherwise a 1.8px stripe, tier had no visual, and (3) katana, sledgehammer, whip, spring fist, cattle prod, zap staff, wet trout and other builtin melee weapons had NO in-hand art whatsoever (invisible in the player's hand). Now: the in-hand weapon drawing was pulled out of drawActor into drawHeldWeapon() so the Smithy can reuse the exact same art; selecting a weapon shows a live animated preview (with an element-coloured glow when infused) plus a stat line; the paint swatches (now 16 + a reset-to-original) genuinely recolour the weapon's main body (bat, pipe, knife, blades, axe/pickaxe/shovel heads, guns...); each tier adds a gold stud along the shaft; and drawGenericMelee gives every previously-invisible melee weapon a readable silhouette (katana, sledgehammer, whip, spring fist, prod/zap staff, trout, generic), all recolourable. Guns got a grip, stock and barrel sheen. Verified in-browser: previews for katana/sledge/whip/prod/knife/shotgun/spring fist/trout render, tier+fire+red paint shows on a katana, in-world katana visible in hand, no console errors.
- PLANNED (not started, user: "get around to this later"): ICE + WET CITY CHAOS. (1) More ice in city fights — throwable freezers (chest freezers / drink coolers) scattered inside and outside shops that shatter into a freeze burst like the other throwable props, so ice can combo with fire/water/spark/gas/oil. (2) Broken hydrants should soak the whole surrounding area (big wet zone, not a single puddle). (3) A much more visible "the ground is wet" read — darker/reflective tint, sheen and ripples on soaked ground so players can see where water/electric/ice combos will trigger.
- 2026-09-24bb: ICE + WET CITY CHAOS (the planned item above, now built). (1) THROWABLE FREEZERS: new 'freezer' prop (pale chest freezer / drink cooler, blue ICE band, drifting cold mist). Scattered on ~30% of city chunks' pavements and placed inside diners, bars, bakeries and the jazz bar. Liftable and throwable like a crate; when broken or landed it FLASH-FREEZES (freezerBurst): enemies who are wet, standing in a puddle or within ~45px freeze solid, other enemies in ~100px are chilled/slowed, nearby puddles turn to slippery cracked ice sheets (no longer conduct electricity), fires are snuffed, and a slippery frost patch is left that freezes anyone wet who walks in (the player only slips/slows — never frozen by their own toy; bosses shrug it off). (2) HYDRANTS now soak the whole area: everyone within ~190px is drenched for 8s, a geyser sprays and keeps flooding outward for 7s, 9 separate puddles are left around the intersection (puddle cap 22→40), and fires nearby are drowned. (3) WET IS VISIBLE: puddles now have a dark soaked-ground halo, a bluer body, rippling rings and a moving glint; soaked people get darker clothes, a blue rippling patch underfoot and heavier dripping. Combo verified in-browser: hydrant + freezer = 4 drenched thugs frozen solid, 8 puddles turned to ice, frost patch, no console errors. Not done: rain-wetting the ground, and wet-ground looks in the village.
- 2026-09-24bc: VETERANS + SQUAD LOADOUT SCREEN. The Armory (E at the weapon rack) now has two tabs: "Belt & kits" and "Squad & gear". Squad & gear lists every villager (pinned first) with a portrait (their actual look, armour and weapon drawn on), level + XP bar, HP, damage bonus, damage taken, raids survived and kills; from it you choose each villager's WEAPON (from the rack) and ARMOUR (from the armour store), and pin them ("Bring on raids") so muster always takes them first. Gear you choose stays on them when you stand the squad down (only auto-issued weapons go back to the rack); guards use their chosen weapon too. PROGRESSION: every squad member who comes home from a raid gains XP (40 + 8 per kill + 60 for a won raid) and levels up to 12 — +10% HP, +7% damage and a little damage reduction per level — announced with a "Veterans grow stronger" banner; kills are tracked per villager. ARMOUR: Leather Vest (-10%, 6 wood), Chain Mail (-20%, 8 stone + 4 favor), Plate Armour (-32%, 16 stone + 10 favor, needs Tempering) forged in a new Armourer section of the Smithy; a won raid also recovers a piece (60% leather / 30% chain / 10% plate). Worn armour is drawn on their body in the world (vest, chain rows, plate with pauldrons + helm). The flat soldier damage reduction is now 20% baseline plus armour and level. Verified in-browser: gear/pin/wear actions, debrief levelled two test villagers correctly, plain soldier took 80 of 100 damage vs 62 (chain, Lv3) and 48 (plate, Lv8), crafting deducted resources, squad spawned with the right HP/weapon/armour, no console errors. Not done: level shown above heads in the world, and a separate helmet/shield slot.
- 2026-09-24bd: THE MERCHANT'S SECOND CONSTRUCTED BEING + BOUND LABOURERS. (1) STONE GOLEM ($1020, ~40% of visits): a big (radius 15, wide torso) grey villager with a stone face (heavy brow, glowing amber eyes, cracks, moss) and a mossy rock-crowned head in the world. Tireless miner (+60% stone, +25% wood), 1.6x HP when mustered/guarding (and it levels like anyone), eats 30% of a normal villager. Drawn in the chat/sit-down face scene and the world sprite. (2) BOUND LABOURERS ($170, up to two different peoples per visit, ~55% of visits — asked for as "slaves from different races"; built as a bound-labour system with consequences rather than a plain purchase): a villager of any people (elf, dwarf, orc, lizard, ...) who works 20% harder but starts resentful (-0.25 mood), and while any is held the village's other members of that people lose mood (-0.12); after 8 days the price is worked off, they become an ordinary free villager and a "Debt worked off" banner shows. Racial talents/feuds/festivals all apply as normal since they carry the real race. Verified in-browser: stock generation offers both, purchases spawn correct actors (golem r15, orc/elf palettes), golem face renders, an 8-day tick counts the term down, mood dips then recovers, food use is lower with a golem, no console errors. Not done: a way to free a bound labourer early, and rebellion/escape risk.
- 2026-09-24be: (1) BUG — NEW COUNTRY: YOU COULDN'T CLAIM A BED. Your claimed bed is stored as coordinates in the player save; New Game+ (a new village in a new country) kept the OLD country's coordinates, so the game thought you already owned a bed, never offered to claim one, and the sleep check found nothing — forcing the admin console to skip nights. Fixed twice over: NG+ now clears the claim, and any claimed bed that doesn't exist in the current village (new country, demolished bed) is treated as no claim. Verified: with a stale bed location set, E at a new bed claims it. (2) FACE + BODY VARIATION IN THE CHAT SCENES: everyone now has a stable set of individual traits (hashed from their look) applied on top of the base face structure — real height and girth (short-and-stocky, tall-and-gangly, squat, tall-and-solid...) which now drives the close-up body (shoulder width, slope, neck length/thickness, head height in frame; the chat torso follows the same rig), head size, and much bigger swings in eye size, spacing, height, slant (drooping or upturned outer corners) and heavy-lidded looks, iris colour (10 real shades instead of hair-derived), brow weight and tilt, nose, mouth, chin, jaw and ear size. Verified with several test villagers in-browser: stocky/broad, tall/long-necked and long-faced people are now clearly different at a glance; no console errors. Not done: the in-world little sprites still use the older build values, and dossier/gift scenes get the face changes but not the chat's custom torso.
- 2026-09-24bf: BIG BATCH ("I like it all, go for it" + reports). (1) GIFT WISHES ARE FINDABLE: what a villager wants is now shown on the chat screen itself ("WANTS: a music box — bring one over and press E (+1 conviction)"), the "Need anything?" answer always leads with it and says where to look (merchant / city), wish lists per wound grew from 2 to 5 objects (so it's no longer teddy bears and couches on repeat), wishes come up much more often (30%/day, 2-day cooldown, was 13%/4) including things you don't own yet, and animated/rare gifts give +2 conviction. (2) IN-WORLD SPRITES follow the same height/girth as the chat portrait (shared faceTraits). (3) BOUND LABOURERS: "Set them free" in the villager menu (they remember: mood bonus), and they may slip away in the night (9%/day if miserable, 4% otherwise, less with a guard; price is lost). (4) SQUAD: level shown over veterans' heads; two new gear slots — helms (Iron Cap, Steel Helm) and shields (Buckler, Tower Shield) — forged at the Smithy, worn from the Squad tab, drawn on the body, all adding to damage reduction. (5) RAIN: the ground now looks wet in the rain (a sheen catching the sky plus spreading ripples). (6) THE SOVEREIGN: the Capital now has its own final boss (a crowned tyrant, not a reskinned monster): while his royal guard lives he takes 55% less damage, his new "By decree!" move summons the guard and a volley, gold cape/scepter/orbiting coins art; +8 legacy points on his fall. (7) POLICE TASER, second pass: against the player it is one 0.6s jolt then 3.5s during which it cannot stun you at all; slower (1.0s) and lighter (6 dmg). (8) PUDDLES: drawn as ONE merged, more transparent layer with soft fading edges (overlaps no longer stack darker), and overlapping puddles merge into a bigger one (up to radius 150) so rain/hydrants/floods make big pools instead of a scatter of small ones. (9) REQUEST-COMPLETE CONFIRMATION: finishing a villager's request (a couch, resources...) now jumps the banner queue with an unmissable "✓ REQUEST COMPLETE" naming the reward, and any gift item they leave is marked on the ground with a gold ring, light and a "★ gift for you" label (it used to be a quiet banner and an item dropped somewhere). (10) FIRE/BLASTS MELT ICE: an open flame or explosion now melts frost patches and ice sheets (a firebarrel on a frozen puddle left it frozen and burning). Bug found and fixed while testing: my puddle layer referenced the camera variable from the wrong scope and stopped the whole frame drawing — caught by the live check, not the syntax check. Verified in-browser: wishes appear on the chat screen, gear slots wear/remove correctly, Sovereign takes 45 of 100 with guards vs 100 without, taser gives one 0.6s stun then immunity, merged puddles, confirmation banner, ice melts under a barrel blast, 0 draw errors in a fresh run.
- 2026-09-24bg: STRANGER AT THE FIRE is a real person now (same idea as the Envoy). No menu pops up when the event starts: a traveller — any people, with their real face/build — walks in from the edge of the village once the morning is under way, stops by the fire (barks lines, "E — talk to the stranger" prompt when you're close), and talking to them opens the welcome / toll / send-away question. Welcome: they become a real villager right where they stand. Toll (50% pay): they pay $30 (or grumble) and walk away. Send away: a parting line and you watch them walk off the map and vanish. Ignored until dusk: they leave on their own. Verified in-browser: walk-in, prompt, the three choices, walk-off, and the villager appearing on welcome; no console errors.
- 2026-09-24bh: (1) SOVEREIGN REMOVED. The Capital's crowned "Sovereign" final boss (2026-09-24bf item 6) came from my own "distinct final boss" suggestion and wasn't something asked for — the existing bosses already guard the capitals. It's fully removed (boss, decree move, guard shield, art); the Capital goes back to one of the existing boss kinds (biome boss, scaled up as the final fight). (2) MORE ESSENCE: beating a boss now gives 2 + the city's tier essence (DNA) — 5 from a tier-3 boss, 10 from the final boss (was 1-2 from any). (3) THE MERCHANT SELLS ESSENCE: once you've beaten a boss (or hold its DNA), his stock can include "3 x <type> essence" for $260 (up to two types per visit) for the Mutation Lab. Verified in-browser: essence amounts, no essence in stock before any boss, essence in stock after.
- 2026-09-24bi: MERCHANT PRICES UP so money matters (passive income made $2k trivial). Essence $260 -> $650 per 3; forged weapons x2.4 (now ~$430-$980); unique weapons $480 -> $1300; racial weapons x2.2 (~$860); robot villager $420 -> $1100; stone golem $1600; bound labourer $900; animated rare decorations x2.2 (~$420-$925); the old event merchant's mystery weapon $90 -> $350. Cheap things (wood, stone, plain decorations) unchanged. Income sources were NOT touched — if $2k still comes too easily, the passive earners (traders, market days, tribute, foxfolk, the city-payout) are the next dial.
